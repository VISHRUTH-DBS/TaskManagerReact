...
const Deferred = () => {
    ...
    console.log("Tasks in Deferred:", tasks);

    // Ensure tasks is an array, if not fall back to an empty array
    const deferredTasks = Array.isArray(tasks) ? tasks.filter(task => task.status === 'Deferred') : [];
